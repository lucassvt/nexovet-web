...
export const metadata: Metadata = {
  ...
  description:
    "Sumate al Club. Ganá puntos con cada compra y canjealos por productos, consultas veterinarias y más.",
}

const REGISTER_HREF = "/account?view=register"
...
export default function Club() {
  return (
    <div style={{ background: "#fafafa" }}>
      ...
      <section
        style={{
          background: "linear-gradient(135deg, #f6a906 0%, #ffbd3a 100%)",
          color: "#0d1816",
        }}
      >
          ...
          {[
            {
              n: "1",
              title: "Registrate",
              desc: "Con tu DNI y email, gratis y en 1 minuto. Sumás 50 puntos de bienvenida.",
            },
            {
              n: "2",
              title: "Comprá",
              desc: "Por cada $90 de compra (online o en sucursal) sumás 1 punto. Tu DNI es tu llave.",
            },
            {
              n: "3",
              title: "Canjeá",
              desc: "Descuentos, productos, consultas veterinarias gratis. Los puntos duran 365 días.",
            },
          ].map((step) => (
            <div
              key={step.n}
              className="text-center p-8 bg-white rounded-xl border-2 border-gray-100"
            >
              <div
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: "#0d1816" }}>
                {step.title}
              </h3>
      ...
      <section className="content-container py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              icon: "🎂",
              title: "Cumple de tu mascota",
              desc: "Cupón de descuento del 20% en alimento para el cumpleaños de tu mascota.",
            },
            {
              icon: "🎁",
              title: "Bienvenida",
              desc: "50 puntos gratis al registrarte con mascota cargada.",
            },
            {
              icon: "👥",
              title: "Referidos",
              desc: "Invitá amigos y ganá 200 puntos cuando hacen su primera compra.",
            },
            {
              icon: "📅",
              title: "Recordatorios",
              desc: "Te avisamos cuándo toca vacunar o desparasitar a tu mascota.",
            },
          ].map((b) => (
            <div
              key={b.title}
              className="p-6 bg-white rounded-xl border border-gray-200 hover:border-[#f6a906] transition-colors"
            >
